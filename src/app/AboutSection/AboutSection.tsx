  ...
  return (
    <div id="about" className="border-x border-border max-w-6xl mx-auto">
      <div className="px-4 sm:px-6 py-8 sm:py-12 md:px-12 md:py-16 lg:px-14 lg:py-16">
        {/* Main heading at top */}
        <h1 className="text-3xl sm:text-4xl md:text-5xl leading-[1.1] font-medium mb-8 sm:mb-12 md:mb-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8">
          {/* Left Column */}
          <div className="flex flex-col w-full sm:w-[400px] lg:w-[450px] mx-auto lg:mx-0">
            {/* Profile Image Container */}
            <div className="rounded-2xl sm:rounded-3xl shadow-2xl h-[300px] sm:h-[400px] overflow-hidden bg-teal-600 aspect-square relative">
              <Image
              ...
              <div className="absolute bottom-3 sm:bottom-4 left-3 sm:left-4 flex gap-1.5 sm:gap-2">
                <a
                  ...
                  className="w-7 h-7 sm:w-8 sm:h-8 bg-black/20 backdrop-blur-md rounded-full flex items-center justify-center hover:bg-black/30 transition-colors"
                >
                  <div className="flex items-center gap-1">
                    <svg
                      viewBox="0 0 24 24"
                      className="w-3 h-3 sm:w-3.5 sm:h-3.5 text-white fill-current"
                    >
            ...
            <div className="mt-4 sm:mt-6">
              <h2 className="text-xl sm:text-2xl font-medium">Akash Nigam</h2>
            ...
            <div className="mt-4">
              ...
              >
                {workHistory.map((item, index) => (
                  <div
                    key={index}
                    className={`absolute w-full bg-white rounded-lg sm:rounded-xl p-3 sm:p-4 transition-all duration-300 ease-in-out`}
                    style={{
                      top: 0,
                      transform:
                        !isExpanded && index > 0
                  ...
                  >
                    ...
                    >
                      <div className="w-full">
                        <h4 className="text-sm sm:text-base mb-1 font-medium text-black">
                          {item.company}
                        </h4>
                        <p className="text-xs sm:text-sm flex justify-between text-muted-foreground">
                          {item.role}
              ...
              <Button
                ...
                className="mx-auto flex text-xs sm:text-sm text-black font-medium cursor-pointer transition-colors bg-white rounded-full px-3 sm:px-4 py-1.5 sm:py-2 shadow-sm border border-border"
              >
          ...
          <div className="space-y-6 sm:space-y-8">
            ...
            <div>
              <Image
                ...
                width={280}
                height={280}
                className="-ml-16 -mt-6 sm:-ml-22 sm:-mt-8 w-[280px] sm:w-[350px]"
              />
            </div>
          </div>
        </div>
